    ...
    companion object {
        ...
        private val HARDCODED_CHANGELOG = listOf(
            ...
            ChangelogVersion(
                ...
                releasedDate = "26 Sep 2026",
                entries = listOf(
                    ChangelogEntry("improvement", "Config Sheets sync: run-index count shows actual runs again (one per run, not per parcel)"),
                ),
            ),
            ChangelogVersion(
            ...
            ChangelogVersion(
                ...
                entries = listOf(
                    ChangelogEntry("improvement", "Petty Cash New/Edit Request: removed the Requested Date field — a submitted request's date now always matches when it was submitted. Already-submitted requests with a distinct requested date keep showing it"),
                ),
            ),
            ChangelogVersion(
                versionName = "5.22.92",
            ...
            ChangelogVersion(
                ...
                releasedDate = "17 Aug 2026",
                entries = listOf(
                    ChangelogEntry("improvement", "Petty Cash: renamed status labels across Dashboard, All Requests, My Requests, and Pending Settlement — Acknowledged is now Verified, Settle in Process is now Ready to Settle. Pending, Approved, Settled, Rejected are unchanged. Only display text changed, not the underlying status values"),
                ),
            ),
            ChangelogVersion(
                versionName = "5.22.90",
            ...
            ChangelogVersion(
                ...
                releasedDate = "17 Aug 2026",
                entries = listOf(
                    ChangelogEntry("improvement", "Petty Cash My Requests (Requester screen): removed the bottom action bar and the large \"+ New Petty Cash Request\" button — both replaced by a single plus icon in the top toolbar, matching the Dashboard's existing pattern. Dashboard/Reports/More screens are for approver roles and aren't relevant here"),
                ),
            ),
            ChangelogVersion(
                versionName = "5.22.88",
