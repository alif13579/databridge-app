...
object FirebasePaths {
     ...
     * see ConfigAreasFragment. delivery_area is destinations a parcel can be
     * routed to (Virtual Routing's Select Area picker reads this once wired
     * to real data); pickup_area is zones a pickup run collects from. ── */
