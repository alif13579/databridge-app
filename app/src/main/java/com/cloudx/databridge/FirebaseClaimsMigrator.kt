...
object FirebaseClaimsMigrator {
    ...
    fun diffClaims(a: ClaimInfo, b: ClaimInfo): List<String> = buildList {
        ...
        if (a.requesterUid != b.requesterUid) add("requesterUid")
        if (a.requesterRole != b.requesterRole) add("requesterRole")
        ...
        if (a.attachments != b.attachments) add("attachments")
        if (a.verifiedByUid != b.verifiedByUid) add("verifiedByUid")
        if (a.verifiedBySystemId != b.verifiedBySystemId) add("verifiedBySystemId")
        if (a.verifiedByName != b.verifiedByName) add("verifiedByName")
        if (a.verifiedAt != b.verifiedAt) add("verifiedAt")
        if (a.verifiedComment != b.verifiedComment) add("verifiedComment")
        if (a.approvedByUid != b.approvedByUid) add("approvedByUid")
