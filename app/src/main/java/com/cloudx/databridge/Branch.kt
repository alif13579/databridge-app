...
data class Branch(
    ...
    val manager_uids: List<String> = emptyList(),
    val manager_roles: List<String> = emptyList(),
    val accountant_uid: String = "",
    val accountant_name: String = "",
    val accountant_role: String = "",
    val accountant_uids: List<String> = emptyList(),
    val accountant_roles: List<String> = emptyList(),
    val petty_cash_poc_uid: String = "",
    val petty_cash_poc_name: String = "",
    val petty_cash_poc_uids: List<String> = emptyList(),
    val petty_cash_poc_roles: List<String> = emptyList(),
    val staff_uid: String = "",
    val staff_name: String = "",
    val staff_role: String = "",
    val staff_uids: List<String> = emptyList(),
